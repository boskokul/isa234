...
@Component({
  selector: 'app-sys-admin-form',
  templateUrl: './sys-admin-form.component.html',
  styleUrls: ['./sys-admin-form.component.css']
})
export class SysAdminFormComponent implements OnInit{
  hide = true
  ...
  constructor(private userService: SysAdminService, private router: Router){}
  ngOnInit(): void {
  }
  ...
  RegisterUser(){
    ...
    this.userService.registerUser(this.user).subscribe({
      next: () => { 
        alert('You just registered a new sys admin!')
